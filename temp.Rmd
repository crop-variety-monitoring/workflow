...
The median average Hamming distance between samples of the same variety is `r round(median(v), 2)`% mutations (the number of mutations relative to the number of usable SNPs in the assay). This is before correcting the reference for any obvious inconsistencies.

```{r bplot, fig.width=4, fig.height=4}
par(mar=c(4, 6, 1, 0))
