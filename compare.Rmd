...
Comparing the results obtained with IBS and DAP. We are only considering IBS scores ≥ 0.8.
...
knitr::kable(x, caption="IBS ≥ 0.8") |> 
  kableExtra::kable_styling(full_width = FALSE)
```
</div>
<div class = "col-md-6">
```{r tab2}
knitr::kable(y, caption="IBS ≥ 0.9") |> 
  kableExtra::kable_styling(full_width = FALSE)
```
</div></div>
...
Given the best match of a field sample to a reference sample in one method; what is the rank of that reference sample in other methods (for IBS ≥ 0.8)?
