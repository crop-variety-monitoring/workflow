...
<div class = "col-md-5">
```{r tab1a}
scrolltab(k[[1]], paste0("varieties (", olabs[1] ,")"))
```
</div>
<div class = "col-md-5">
```{r tab2a}
scrolltab(k[[2]], paste0("varieties (", olabs[2] ,")"))
```
</div></div>


Best matches for IBS>0.8 and DAP>0.5 
...
qq <- q[[1]]
qq <- qq[qq[,1] == qq[,2], ]
scrolltab(qq, paste0("varieties (", olabs[1] ,")"))
```
</div>
<div class = "col-md-5">
```{r tab4a}
qq <- q[[2]]
qq <- qq[qq[,1] == qq[,2], ]
scrolltab(qq, paste0("varieties (", olabs[2] ,")"))
```
</div></div>
