...
ordnr <- "DEra22-7523_1_moreOrders"
#"DCob22-7521_moreOrders"
#"DRi23-7825"
...
3) There can be multiple separate groups for the same variety that are genetically very distant. These are labeled `a`, `b`, etc (not implemented yet). 
...
In the case of diploid clonally propagated crops and inbreeding species, one would expect that, if a sample consisted of a single genotype, the counts for each heterozygous SNP variant would have a proportion of about 1. The "heterozygosity index" is the median score of these proportions for all heterozygous markers of a variety. Samples with less then 20% heterozygous markers are not considered.
