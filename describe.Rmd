...
In the case of clonally propagated or inbreeding species, one would expect that, if a sample consisted of a single genotype, the counts for each heterozygous SNP variant would have a proportion of 1. The "heterozygosity index" is the median score for all heterozygous markers of a variety. 

```{r purity, fig.width=4, fig.height=4}
